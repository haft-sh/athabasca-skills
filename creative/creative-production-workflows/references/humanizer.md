# Absorbed skill: `humanizer`

This file preserves the original SKILL.md content from `humanizer` after consolidation into the umbrella skill `creative-production-workflows`. Relative support-file links have been rewritten to their re-homed umbrella paths where they were explicit.
