# Absorbed skill: `ideation`

This file preserves the original SKILL.md content from `ideation` after consolidation into the umbrella skill `creative-production-workflows`. Relative support-file links have been rewritten to their re-homed umbrella paths where they were explicit.
...
See `references/ideation-full-prompt-library.md` for 30+ additional constraints across communication, scale, philosophy, transformation, and more.
